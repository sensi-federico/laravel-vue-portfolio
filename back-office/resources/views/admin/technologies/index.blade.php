...
@section('content')
    <div class="d-flex justify-content-end mt-3">
        <a href="{{ route('admin.technologies.create') }}" class="btn btn-primary mb-3" role="button">Add technology</a>
    </div>
                    ...
                    <tr class="">
                        ...
                        <td class="d-flex align-items-center">
                            ...
                            <a href='{{ route('admin.technologies.edit', $technology->id) }}'
                                class="btn btn-secondary edit m-2">
