            ...
            <tbody class="table-group-divider">
                @forelse ($projects as $project)
                    <tr class="table-primary">
                        ...
                        <td>{{ $project->title }}</td>
                        <td>
                            <img src="{{ asset('storage/' . $project->image) }}" alt="" width="80px">
                        </td>
                        <td>{{ $project->description }}</td>
                        <td class="d-flex flex-column">
                            <a href='{{ route('admin.projects.show', $project->slug) }}' class="btn btn-primary view m-2">
                            ...
                            <a href='{{ route('admin.projects.edit', $project->slug) }}' class="btn btn-secondary edit m-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
